...
//
//     final reviewGetCompanyModel = reviewGetCompanyModelFromJson(jsonString);

import 'dart:convert';

ReviewGetCompanyModel reviewGetCompanyModelFromJson(String str) => ReviewGetCompanyModel.fromJson(json.decode(str));

String reviewGetCompanyModelToJson(ReviewGetCompanyModel data) => json.encode(data.toJson());

class ReviewGetCompanyModel {
  bool? status;
  Collage? collage;
  List<Review>? reviews;

  ReviewGetCompanyModel({
    this.status,
    this.collage,
    this.reviews,
  });

  factory ReviewGetCompanyModel.fromJson(Map<String, dynamic> json) => ReviewGetCompanyModel(
    status: json["status"],
...
//     status: json["status"],
//     collage: json["collage"] == null ? null : Collage.fromJson(json["collage"]),
//     reviews: json["reviews"] == null ? [] : List<Review>.from(json["reviews"]!.map((x) => x)),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "status": status,
