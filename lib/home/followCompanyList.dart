...
class FollowCompanyPage extends ConsumerStatefulWidget {
  final int id;
  final String companyName;

  const FollowCompanyPage(this.id, this.companyName,{super.key});

  @override
  ConsumerState<FollowCompanyPage> createState() => _FollowCompanyPageState();
}

class _FollowCompanyPageState extends ConsumerState<FollowCompanyPage> {
  @override
