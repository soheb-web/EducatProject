...
class ComapnyUsersPage extends ConsumerStatefulWidget {
  final int id;
  final String companyName;

  const ComapnyUsersPage(this.id, this.companyName,{super.key});

  @override
  ConsumerState<ComapnyUsersPage> createState() => _ComapnyUsersPageState();
}

class _ComapnyUsersPageState extends ConsumerState<ComapnyUsersPage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text('${widget.companyName} Alumni',style: TextStyle( color: Colors.white,),),
        centerTitle: true,
        leading: InkWell(
          onTap: () {
