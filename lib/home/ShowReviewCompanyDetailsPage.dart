...
class ShowReviewCompanyDetailsPage extends ConsumerStatefulWidget {
  final Review review;
  final bool isViewOnly;

  const ShowReviewCompanyDetailsPage({
    super.key,
  ...
  @override
  ConsumerState<ShowReviewCompanyDetailsPage> createState() =>
      _ShowReviewCompanyDetailsPageState();
}

class _ShowReviewCompanyDetailsPageState extends ConsumerState<ShowReviewCompanyDetailsPage> {
