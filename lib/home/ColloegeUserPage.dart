...
class Colloegeuserpage extends ConsumerStatefulWidget {
  final int id;
  final String collegeName;

  const Colloegeuserpage(this.id,this.collegeName, {super.key});

  @override
  ConsumerState<Colloegeuserpage> createState() => _ColloegeuserpageState();
}

class _ColloegeuserpageState extends ConsumerState<Colloegeuserpage> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text('${widget.collegeName} Alumni',style: TextStyle( color: Colors.white,),),
        centerTitle: true,
        leading: InkWell(
          onTap: () {
      ...
      body: reviewAsync.when(
        ...
        data: (snap) {
          ...
          if (college == null || college.users == null || college.users!.isEmpty) {
            return const Center(
              child: Text(
                "No users found",
