...
class StudenetDetailPage extends ConsumerStatefulWidget {
  final int id;
  StudenetDetailPage({super.key, required this.id});

  @override
  ConsumerState<StudenetDetailPage> createState() => _StudenetDetailPageState();
}

class _StudenetDetailPageState extends ConsumerState<StudenetDetailPage> {
